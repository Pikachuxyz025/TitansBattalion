...
public class Interaction : NetworkBehaviour
{
    ...
    [SerializeField] private ChessboardTileManager pieceManager;
    ...
    public override void OnNetworkSpawn()
    {
        ...
        pieceManager = ChessboardTileManager.instance;
    }
    ...
    private void Interact()
    {
        ...
        {
            ChessboardTile connectionContact = info.transform.gameObject.GetComponent<ChessboardTile>();
