...
public class SID_Suns : SID_Chessman_Mirror
{
    ...
    public bool SunMoves(int x, int y, ref Dictionary<Points, bool> confirmation)
    {
        bool r = new bool();
    ...
    public override IEnumerator CalculateCurrentMoves()
    {
        ...
        do
        {
            x--;
            y++;
        } while (SunMoves(x, y, ref confirmedMoves));
        ...
        {
            x++;
        } while (SunMoves(x, CurrentY, ref confirmedMoves));
        ...
        {
            x++;
        } while (SunMoves(CurrentX, x, ref confirmedMoves));
    ...
    public override IEnumerator FutureSight(int curX, int curY)
    {
        ...
        do
        {
            x--;
            y++;
        } while (SunMoves(x, y, ref futureMoves));
        ...
        {
            x++;
        } while (SunMoves(x, curY, ref futureMoves));
        ...
        {
            x++;
        } while (SunMoves(curX, x, ref futureMoves));
