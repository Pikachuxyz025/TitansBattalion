...
public class Player_Mirror : NetworkBehaviour
{
    ...
    public void ReturnToMainMenu()
    {
        if (isServer)
        {
            ...
            SceneManager.MoveGameObjectToScene(GameObject.Find("NetworkManager"), SceneManager.GetActiveScene());
    ...
    private IEnumerator Return()
    {
        ...
        MatchMaker.instance.SetMatchInProgress(MatchID, false);
        yield return null;
    }
    ...
    IEnumerator SetupnActive()
    {
        ...
        yield return asyncOperation;
        Scene _scene = SceneManager.GetSceneByBuildIndex(2);
    ...
    public void SceneChange(int _BoardID)
    {
        ...
        manager.GetComponent<MirrorGameManager>().SelectBoard(_BoardID);
        manager.GetComponent<PlayerSpawnSystem>().SpawnSystemSetup();

        RpcService("the board ID for this scene is: " + _BoardID);
    }
