...
namespace Mirror
{
    ...
    public class NetworkRoomManager : NetworkManager
    {
        ...
        protected NetworkRoomPlayerLobby roomPlayerPrefab;
        ...
        public List<NetworkRoomPlayerLobby> roomSlots = new List<NetworkRoomPlayerLobby>();
        ...
        internal void ReadyStatusChanged()
        {
            ...
            foreach (NetworkRoomPlayerLobby item in roomSlots)
            {
                if (item != null)
                {
                    CurrentPlayers++;
        ...
        public override void OnServerReady(NetworkConnection conn)
        {
            ...
            if (conn != null && conn.identity != null)
            {
                ...
                if (roomPlayer != null && roomPlayer.GetComponent<NetworkRoomPlayerLobby>() != null)
        ...
        public void CheckReadyToBegin()
        {
            ...
            int numberOfReadyPlayers = NetworkServer.connections.Count(conn => conn.Value != null && conn.Value.identity.gameObject.GetComponent<NetworkRoomPlayerLobby>().readyToBegin);
        ...
        public override void OnServerDisconnect(NetworkConnection conn)
        {
            ...
            {
                NetworkRoomPlayerLobby roomPlayer = conn.identity.GetComponent<NetworkRoomPlayerLobby>();
                ...
                {
                    roomPlayer = clientOwnedObject.GetComponent<NetworkRoomPlayerLobby>();
                    if (roomPlayer != null)
                        roomSlots.Remove(roomPlayer);
                }
            }
            ...
            {
                if (player != null)
                    player.GetComponent<NetworkRoomPlayerLobby>().readyToBegin = false;
            }
        ...
        public override void ServerChangeScene(string newSceneName)
        {
            ...
            {
                foreach (NetworkRoomPlayerLobby roomPlayer in roomSlots)
                {
                    if (roomPlayer == null)
                        continue;
                    ...
                    if (NetworkServer.active)
                    {
                        ...
                        roomPlayer.GetComponent<NetworkRoomPlayerLobby>().readyToBegin = false;
