...
public class ChessboardGenerator : NetworkBehaviour
{
    ...
    private void GenerateTile(int x, int y, int id)
    {
        ...
        ChessboardTile connection = null;
        if (generatedChessTile.GetComponent<ChessboardTile>() != null)
            connection = generatedChessTile.GetComponent<ChessboardTile>();
        ...
        ChessboardTileManager.instance.AddPoints(xz, yz, generatedChessTile);
