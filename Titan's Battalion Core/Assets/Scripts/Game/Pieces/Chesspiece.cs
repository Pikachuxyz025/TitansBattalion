...
public class Chesspiece : NetworkBehaviour
{
   ...
   [SerializeField] protected ChessboardTileManager chessManager;
    ...
    private void Awake()
    {
        ...
        chessManager = ChessboardTileManager.instance;
    }
   ...
   protected bool CurrentPieceCheck(Points p)
    ...
    public void SetupPiece(int teamNum, Player player)
    {
        ...
        ChessboardTileManager.instance.activeChesspieces.Add(this);
    }
    ...
    public bool IsInCheck()
    {
        ...
        ChessboardTile conn = chessManager.GetChesspieceConnection(new Points(currentX, currentY));
        if (conn == null)
            return b;
    ...
    {
        ChessboardTileManager che = ChessboardTileManager.instance;
        ...
        switch (type)
        {
            case SetType.Manual:
                ...
                for (int i = 0; i < addedPoints.Count; i++)
                {
                    ...
                    if (!ChessboardTileManager.instance.IsCoordinateInList(addedPoint))
                        continue;
