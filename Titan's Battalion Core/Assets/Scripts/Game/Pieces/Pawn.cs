...
public class Pawn : Chesspiece
{
    ...
    private ChessboardTile enPassantPoint;
    ...
    {
        ChessboardTile currentConn = chessManager.GetChesspieceConnection(new Points(currentX, currentY));
    ...
    public void ConvertToQueenServerRpc()
    {
        if (CanCovertToQueen())
        {
            ...
            ChessboardTile currentChessboardPiece = chessManager.GetChesspieceConnection(new Points(currentX, currentY));
